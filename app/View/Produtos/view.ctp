<?php
$foto = $this->Html->div('col-md-4',
$this->Html->div('card mb-4 box-shadow',
    $this->Html->image($produto['Produto']['foto'], array('class' => 'card-img-top', 'style' => 'height: 250px; width: 100%; display: block;'))
)
);
$inputDefaults = array(
    'class' => 'form-control',
...
echo $this->Html->para('h1', 'Detalhes do Produto');
echo $this->Html->div('row', $foto);
echo $form;
